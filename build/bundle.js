    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 55, 76, 2062);
    			attr_dev(p, "class", "large");
    			add_location(p, file, 55, 3, 1989);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 47, 67, 1714);
    			attr_dev(p, "class", "large tip-text");
    			add_location(p, file, 47, 3, 1650);
    			add_location(br0, file, 48, 3, 1799);
    			attr_dev(input, "type", "number");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", "100");
    			input.readOnly = input_readonly_value = !/*calcNotFinished*/ ctx[1];
    			set_style(input, "width", "300px");
    			add_location(input, file, 50, 4, 1836);
    			attr_dev(span1, "class", "percent");
    			add_location(span1, file, 49, 3, 1808);
    			add_location(br1, file, 52, 3, 1960);
    			add_location(br2, file, 53, 3, 1969);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			mount_component(fa, p, null);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 66, 44, 2551);
    			attr_dev(p, "class", "x-large");
    			add_location(p, file, 66, 4, 2511);
    			attr_dev(button0, "class", "btn");
    			add_location(button0, file, 67, 4, 2600);
    			attr_dev(button1, "class", "btn btn-primary");
    			add_location(button1, file, 68, 4, 2663);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 63, 4, 2345);
    			attr_dev(button, "class", "btn");
    			add_location(button, file, 64, 4, 2436);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 59, 3, 2179);
    			attr_dev(button1, "class", "btn");
    			add_location(button1, file, 60, 3, 2253);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button0, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(59:2) {#if calcNotFinished}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			if_block1.c();
    			add_location(h1, file, 38, 2, 1171);
    			attr_dev(p0, "class", "large");
    			add_location(p0, file, 39, 2, 1208);
    			...
    			add_location(input0, file, 41, 3, 1315);
    			attr_dev(span, "class", "dollar");
    			add_location(span, file, 40, 2, 1289);
    			attr_dev(p1, "class", "large");
    			add_location(p1, file, 43, 2, 1440);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "step", "1");
    			input1.readOnly = input1_readonly_value = !/*calcNotFinished*/ ctx[1];
    			set_style(input1, "width", "300px");
    			add_location(input1, file, 44, 2, 1520);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 37, 1, 1144);
    			add_location(main, file, 36, 0, 1135);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
